...
export class ClassifyVendorDto {
  // [AI] The route POST /api/vendors/classify has no :id param in the
  // spec's endpoint table — unlike PATCH /vendors/{id}/classification.
  ...
  // Alternative (equally valid reading of the PDF): accept the raw fields
  // (companyName, techStack, etc.) directly in the body with no DB lookup
